...
from utils import hexsplit
from cipher_suites import (
    CipherSuiteEnum, ECSupportedGroupEnum, SignatureHashAlgorithms
)

from formats.client_hello import *
from formats.server_hello import *
...
client_hello = client_hello_format.build({
    ...
    "cipher_suites": [hexsplit(x.value) for x in CipherSuiteEnum],
    ...
    "extension_supported_groups": {
        ...
        "supported_groups": [hexsplit(x.value) for x in ECSupportedGroupEnum]
    },
    "extension_signature_algorithms": {
        ...
        "signature_hash_algorithms": [
            hexsplit(x.value) for x in SignatureHashAlgorithms
        ]
    },
...
while True:
    ...
    if not result:
        ...
        break
s.close()
server_hello_response = server_hello_format.parse(response)
print(server_hello_response)
